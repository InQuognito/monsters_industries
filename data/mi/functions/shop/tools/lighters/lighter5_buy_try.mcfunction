...
execute if score @s lighterLevel matches 5 unless score #temp ct.paper >= #lighter5Paper price run title @s actionbar [{"text":"You do not have enough paper to purchase the ","color":"red"},{"text":"Flamethrower","color":"dark_gray"},{"text":"!","color":"red"}]
execute if score @s lighterLevel matches 5 unless score #temp ct.netherite >= #lighter5Netherite price run title @s actionbar [{"text":"You do not have enough netherite to purchase the ","color":"red"},{"text":"Flamethrower","color":"dark_gray"},{"text":"!","color":"red"}]
