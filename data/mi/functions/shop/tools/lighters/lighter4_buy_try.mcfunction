...
execute if score @s lighterLevel matches 4 unless score #temp ct.paper >= #lighter4Paper price run title @s actionbar [{"text":"You do not have enough paper to purchase the ","color":"red"},{"text":"Flint and Pyrite","color":"gold"},{"text":"!","color":"red"}]
execute if score @s lighterLevel matches 4 unless score #tokenCount temp >= #lighter4Token price run title @s actionbar [{"text":"You do not have enough tokens to purchase the ","color":"red"},{"text":"Flint and Pyrite","color":"gold"},{"text":"!","color":"red"}]
