...
execute if score @s pickaxeLevel matches 5 unless score #temp ct.paper >= #pickaxe5Paper price run title @s actionbar [{"text":"You don't have enough paper to purchase the ","color":"red"},{"text":"Dwarven Pickaxe","color":"dark_gray"},{"text":"!","color":"red"}]
execute if score @s pickaxeLevel matches 5 unless score #temp ct.netherite >= #pickaxe5Netherite price run title @s actionbar [{"text":"You don't have enough netherite to purchase the ","color":"red"},{"text":"Dwarven Pickaxe","color":"dark_gray"},{"text":"!","color":"red"}]
