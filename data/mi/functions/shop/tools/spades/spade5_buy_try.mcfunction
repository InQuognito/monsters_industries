...
execute if score @s spadeLevel matches 5 unless score #temp ct.paper >= #spade5Paper price run title @s actionbar [{"text":"You do not have enough paper to purchase the ","color":"red"},{"text":"Gravedigger's Shovel","color":"dark_gray"},{"text":"!","color":"red"}]
execute if score @s spadeLevel matches 5 unless score #temp ct.netherite >= #spade5Netherite price run title @s actionbar [{"text":"You do not have enough netherite to purchase the ","color":"red"},{"text":"Gravedigger's Shovel","color":"dark_gray"},{"text":"!","color":"red"}]
