...
execute unless score @s spadeLevel matches 2.. unless score #temp ct.bone >= #spade1Bone price run title @s actionbar [{"text":"You do not have enough bones to purchase a ","color":"red"},{"text":"Crude Spade","color":"gray"},{"text":"!","color":"red"}]
