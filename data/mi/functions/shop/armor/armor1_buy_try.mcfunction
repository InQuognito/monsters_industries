...
execute if score @s armorLevel matches ..0 unless score #temp ct.paper >= #armor1 price run title @s actionbar [{"text":"You don't have enough paper to purchase ","color":"red"},{"text":"Golden Armor","color":"gold"},{"text":"!","color":"red"}]
