...
execute unless score @s production.paper matches 2.. unless score #temp ct.paper >= #paperProduction1 price run title @s actionbar [{"text":"You don't have enough paper to purchase ","color":"red"},{"text":"Paper Production 1","color":"gray"},{"text":"!","color":"red"}]
