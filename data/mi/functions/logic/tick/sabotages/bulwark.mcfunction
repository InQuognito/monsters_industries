execute if score #team1Bulwark temp matches 1 as @e[type=#mi:hostile_mobs,type=!minecraft:wither,team=team1] run attribute @s minecraft:generic.armor base set 10.0
...
execute if score #team2Bulwark temp matches 1 as @e[type=#mi:hostile_mobs,type=!minecraft:wither,team=team2] run attribute @s minecraft:generic.armor base set 10.0
