...
scoreboard players set @s[nbt={Inventory:[{id:"minecraft:diamond_sword"}]}] swordLevel 3
scoreboard players set @s[nbt={Inventory:[{id:"minecraft:netherite_sword"}]}] swordLevel 4
