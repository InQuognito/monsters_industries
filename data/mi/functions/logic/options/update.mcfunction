...
execute if score $rushMode options matches 250 run data modify storage mi:data options append value {"text":"OFF","color":"red"}
execute if score $rushMode options matches 500 run data modify storage mi:data options append value {"text":"ON","color":"green"}
