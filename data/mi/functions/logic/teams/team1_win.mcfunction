...
execute unless score #forfeit temp matches 1 run title @a title {"text":"Team 1 Wins!","color":"aqua"}
execute if score #forfeit temp matches 1 run title @a title {"text":"Team 2 Forfeits!","color":"aqua"}
...
execute unless score #playerAmount temp matches ..1 run scoreboard players add @a[team=team1] stats.gWon 1
