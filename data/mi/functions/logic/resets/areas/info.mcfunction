# Core
summon minecraft:text_display -26.5 7.0 -90.5 {text:'{"text":"Core","color":"white","bold":true}'}
...
# Resources
summon minecraft:text_display -26.5 7.0 -86.5 {text:'{"text":"Resources","color":"white","bold":true}'}
...
# Areas
summon minecraft:text_display -30.5 7.0 -90.5 {text:'{"text":"Areas","color":"white","bold":true}'}
