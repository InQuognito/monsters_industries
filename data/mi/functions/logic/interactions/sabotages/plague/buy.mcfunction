...
execute if score #team2Plague temp matches 1 run scoreboard players operation $team1 stock -= #plague price
execute if score #team1Plague temp matches 1 run scoreboard players operation $team2 stock -= #plague price
