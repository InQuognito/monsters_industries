...
execute at @e[type=minecraft:marker,tag=location.team1.bone] run setblock ~ ~1 ~ minecraft:birch_wall_sign[facing=north]{front_text:{color:"black",messages:['[{"text":"Like this"}]','[{"text":"headstone?"}]','[{"text":"Give us a call"}]','[{"text":"at 1-800-DEAD"}]']},is_waxed:1b} replace
