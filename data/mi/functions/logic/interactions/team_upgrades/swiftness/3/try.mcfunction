...
execute unless score #temp ct.paper >= #swiftness3 price run title @s actionbar [{"text":"You don't have enough paper to purchase ","color":"red"},{"text":"Swiftness 3","color":"gold"},{"text":"!","color":"red"}]
