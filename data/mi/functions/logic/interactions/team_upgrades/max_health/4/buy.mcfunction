...
data merge block ^ ^1 ^ {front_text:{color:"black",messages:['[""]','[{"text":"[ 4 / 5 ]"}]','[{"score":{"name":"#maxHealth5Paper","objective":"price"}},{"text":" Paper"}]','[{"score":{"name":"#maxHealth5Slimeball","objective":"price"}},{"text":" Slimeballs"}]']},is_waxed:1b}
