...
execute unless score #temp ct.paper >= #maxHealth5Paper price run title @s actionbar [{"text":"You don't have enough paper to purchase ","color":"red"},{"text":"Max Health 5","color":"gold"},{"text":"!","color":"red"}]
execute unless score #temp ct.slimeball >= #maxHealth5Slimeball price run title @s actionbar [{"text":"You don't have enough slimeballs to purchase ","color":"red"},{"text":"Max Health 5","color":"gold"},{"text":"!","color":"red"}]
