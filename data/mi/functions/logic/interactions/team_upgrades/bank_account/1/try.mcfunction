...
execute unless score #temp ct.paper >= #bankAccount1 price run title @s actionbar [{"text":"You don't have enough paper to purchase a ","color":"red"},{"text":"Bank Account","color":"gold"},{"text":"!","color":"red"}]
