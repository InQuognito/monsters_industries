...
execute if score #stockPercent temp < #wallStreetMax vars unless score #temp ct.paper >= #wallStreet1 price run title @s actionbar {"text":"You do not have enough paper to purchase stock!","color":"red"}
