...
execute if score #stockPercent temp < #wallStreetMax vars unless score #temp ct.paper >= #wallStreet2 price run title @s actionbar {"text":"You don't have enough paper to purchase stock!","color":"red"}
