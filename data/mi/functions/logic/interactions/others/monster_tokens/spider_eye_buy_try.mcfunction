...
execute unless score #temp ct.spiderEye >= #monsterTokenSpiderEye price run title @s actionbar {"text":"You don't have enough spider eyes to purchase a monster token!","color":"red"}
