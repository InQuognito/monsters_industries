...
execute unless score #temp ct.gunpowder >= #monsterTokenGunpowder price run title @s actionbar {"text":"You don't have enough gunpowder to purchase a monster token!","color":"red"}
