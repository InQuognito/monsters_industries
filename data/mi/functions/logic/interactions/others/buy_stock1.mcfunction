...
execute if entity @s[team=team1] run tellraw @a[team=team1,tag=!self] [{"text":"Your teammate has purchased ","color":"green"},{"score":{"name":"#wallStreet1","objective":"vars"},"color":"gold"},{"text":" stock!","color":"green"}]
execute if entity @s[team=team2] run tellraw @a[team=team2,tag=!self] [{"text":"Your teammate has purchased ","color":"green"},{"score":{"name":"#wallStreet1","objective":"vars"},"color":"gold"},{"text":" stock!","color":"green"}]
tag @s remove self
