...
execute if score #temp enchantment matches ..2 unless score #temp ct.paper >= #enchantmentLuckPaper price run title @s actionbar {"text":"You don't have enough paper to upgrade enchantment luck!","color":"red"}
execute if score #temp enchantment matches ..2 unless score #temp ct.netherite >= #enchantmentLuckNetherite price run title @s actionbar {"text":"You don't have enough netherite to upgrade enchantment luck!","color":"red"}
