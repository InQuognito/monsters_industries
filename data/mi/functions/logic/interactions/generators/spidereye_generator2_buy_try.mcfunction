...
execute unless score #temp ct.paper >= spiderEyeTrack2Paper price run title @s actionbar {"text":"You do not have enough paper to shorten the track!","color":"red"}
execute unless score #temp ct.spiderEye >= spiderEyeTrack2SpiderEye price run title @s actionbar {"text":"You do not have enough spider eyes to shorten the track!","color":"red"}
