...
execute unless score #temp ct.paper >= spiderEyeTrack1Paper price run title @s actionbar {"text":"You don't have enough paper to shorten the track!","color":"red"}
execute unless score #temp ct.spiderEye >= spiderEyeTrack1SpiderEye price run title @s actionbar {"text":"You don't have enough spider eyes to shorten the track!","color":"red"}
