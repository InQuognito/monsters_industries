...
execute unless score #temp ct.slimeball >= #slimeballReactorSlimeball price run title @s actionbar {"text":"You do not have enough slimeballs to repair this reactor!","color":"red"}
