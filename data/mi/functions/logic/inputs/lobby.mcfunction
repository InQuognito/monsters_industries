...
# Settings (From Lobby)
execute positioned -24.5 6.5 -111.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run teleport @p[advancements={mi:utility/click_button=true}] -28.5 5.0 -119.5 180.0 0.0
...
# Lobby (From Settings)
execute positioned -28.5 6.5 -117.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run teleport @p[advancements={mi:utility/click_button=true}] -28.5 5.0 -108.5 270.0 0.0
...
# Info (From Lobby)
execute positioned -24.5 6.5 -110.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run teleport @p[advancements={mi:utility/click_button=true}] -28.5 5.0 -97.5 0.0 0.0
...
# Lobby (From Info)
execute positioned -28.5 6.5 -99.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run teleport @p[advancements={mi:utility/click_button=true}] -28.5 5.0 -108.5 270.0 0.0
