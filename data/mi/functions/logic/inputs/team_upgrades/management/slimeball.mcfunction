...
execute if entity @s[team=team1] run scoreboard players set #team1EmployeeResource temp 6
execute if entity @s[team=team2] run scoreboard players set #team2EmployeeResource temp 6
