...
execute if score #team1 sentryCount matches 10 positioned 131 19 -126 run function mi:maps/power_plant/logic/interactions/others/summon_phoenix_sentry_team1
