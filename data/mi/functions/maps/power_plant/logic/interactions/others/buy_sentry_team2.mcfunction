...
summon minecraft:iron_golem 149 19 -125 {CustomName:'[{"text":"Sentry","color":"red"}]',Health:125,PersistenceRequired:1b,Attributes:[{Name:"generic.armor",Base:10d},{Name:"minecraft:generic.follow_range",Base:2048d},{Name:"minecraft:generic.max_health",Base:125d}],Team:team2}
...
tellraw @a[team=team2,tag=!self] [{"selector":"@s","color":"yellow"},{"text":" has deployed a sentry!","color":"green"}]
tag @s remove self
