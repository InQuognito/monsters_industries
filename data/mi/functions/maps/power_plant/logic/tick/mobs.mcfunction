...
execute if score $rushMode options matches 1 unless score $team1StockPercent temp matches 75.. if entity @e[tag=newMob,team=team1] run scoreboard players add $team1 stock 1
execute if score $rushMode options matches 1 unless score $team2StockPercent temp matches 75.. if entity @e[tag=newMob,team=team2] run scoreboard players add $team2 stock 1
