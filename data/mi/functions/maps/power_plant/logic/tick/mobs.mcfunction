teleport @e[team=team1,tag=newMob,x=140,y=18,z=-141,dx=1,dy=2,dz=5] 145.0 19 -138.0
teleport @e[team=team1,tag=newMob,x=140,y=18,z=-115,dx=1,dy=2,dz=5] 145.0 19 -112.0

teleport @e[team=team2,tag=newMob,x=139,y=18,z=-141,dx=1,dy=2,dz=5] 136.0 19 -138.0
teleport @e[team=team2,tag=newMob,x=139,y=18,z=-115,dx=1,dy=2,dz=5] 136.0 19 -112.0
...
execute if score #phoenixSentryTeam1 timer matches 600.. run function mi:maps/power_plant/logic/interactions/others/summon_phoenix_sentry_team1
execute if score #phoenixSentryTeam2 timer matches 600.. run function mi:maps/power_plant/logic/interactions/others/summon_phoenix_sentry_team2
