...
# Sabotage Room
execute positioned 129.5 19.0 -91.5 if block ~ ~ ~ #minecraft:pressure_plates[powered=true] as @e[team=team1,distance=..1,sort=nearest,limit=1] run teleport @s 79.5 13.0 -106.5 180.0 0.0
...
execute positioned 151.5 19.0 -161.5 if block ~ ~ ~ #minecraft:pressure_plates[powered=true] as @e[team=team2,distance=..1,sort=nearest,limit=1] run teleport @s 201.5 13.0 -143.5 0.0 0.0
