...
execute positioned 188.5 22.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function mi:maps/power_plant/logic/mob_shop/team2/check_mob
execute positioned 189.5 22.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function mi:maps/power_plant/logic/mob_shop/team2/check_mob
execute positioned 188.5 21.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function mi:maps/power_plant/logic/mob_shop/team2/check_mob
execute positioned 189.5 21.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function mi:maps/power_plant/logic/mob_shop/team2/check_mob
execute positioned 188.5 20.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function mi:maps/power_plant/logic/mob_shop/team2/check_mob
execute positioned 189.5 20.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function mi:maps/power_plant/logic/mob_shop/team2/check_mob
