...
execute positioned 129.5 19.5 -165.5 if block ~ ~ ~ #minecraft:buttons[powered=true] if score #team1SpiderEyeGenerator temp matches 1 as @p[team=team1] run function mi:logic/interactions/generators/spidereye_generator2_buy_try
execute positioned 129.5 19.5 -165.5 if block ~ ~ ~ #minecraft:buttons[powered=true] unless score #team1SpiderEyeGenerator temp matches 1.. as @p[team=team1] run function mi:logic/interactions/generators/spidereye_generator1_buy_try
...
execute positioned 151.5 19.5 -87.5 if block ~ ~ ~ #minecraft:buttons[powered=true] if score #team2SpiderEyeGenerator temp matches 1 as @p[team=team2] run function mi:logic/interactions/generators/spidereye_generator2_buy_try
execute positioned 151.5 19.5 -87.5 if block ~ ~ ~ #minecraft:buttons[powered=true] unless score #team2SpiderEyeGenerator temp matches 1.. as @p[team=team2] run function mi:logic/interactions/generators/spidereye_generator1_buy_try
